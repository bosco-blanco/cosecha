      ...
      body: ListView(
        ...
        children: [
          ...
          _MenuTile(
            ...
            onTap: () => context.push('/crm/contactos'),
          ),
          ...
          _MenuTile(
            ...
            onTap: () => context.push('/portal/solicitudes'),
          ),
          _MenuTile(
            icon: Icons.work_outline,
            label: 'Bolsa de Empleo',
            subtitle: 'Ofertas internas ECDB',
            onTap: () => context.push('/portal/ofertas'),
          ),
          _MenuTile(
            icon: Icons.group_add_outlined,
            label: 'Referidos',
            subtitle: 'Programa de referidos (200€)',
            onTap: () => context.push('/portal/referidos'),
          ),
